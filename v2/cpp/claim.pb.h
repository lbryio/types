...
enum Claim_Type {
  ...
  Claim_Type_Claim_Type_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  Claim_Type_Claim_Type_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class File final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.File) */ {
 public:
  File();
  virtual ~File();
...
inline const ::pb::Stream& Claim::stream() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::pb::Stream*>(
...
inline const ::pb::Channel& Claim::channel() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::pb::Channel*>(
...
inline const ::pb::File& Stream::file() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::pb::File*>(
...
inline const ::pb::Video& Stream::video() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::pb::Video*>(
